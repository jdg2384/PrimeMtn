...
class ContactMsgForm(ContactMsgSecurityForm):
    ...
    name = forms.CharField(label=_(""), max_length=100,
                           widget=forms.TextInput(
                            attrs={'placeholder': _('Your Name*'), "maxlength": 100}))
    email = forms.EmailField(label=_(""), max_length=200,
                             widget=forms.TextInput(attrs={'placeholder': _('Your Email*'), "maxlength": 200}))
